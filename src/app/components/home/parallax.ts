...
const helpers: any = {
    ...
    camelCase(value: any) {
        return value.replace(/-+(.)?/g, (_match, character) => {
...
class Parallax {
    ...
    constructor(element: any, options: any) {
        ...
        if (!this.setInputElement) {
            this.setInputElement = this.element
        }

        this.onCalibrationTimer = null
    ...
    updateDimensions() {
        ...
        this.windowCenterX = this.windowWidth * this.origin
        this.windowCenterY = this.windowHeight * this.origin
        this.windowRadiusX = Math.max(this.windowCenterX, this.windowWidth - this.windowCenterX)
        this.windowRadiusY = Math.max(this.windowCenterY, this.windowHeight - this.windowCenterY)
    }

    updateBounds() {
        this.bounds = this.setInputElement.getBoundingClientRect()
        this.elementPositionX = this.bounds.left
        this.elementPositionY = this.bounds.top
        this.elementWidth = this.bounds.width
        this.elementHeight = this.bounds.height
        this.elementCenterX = this.elementWidth * this.origin
        this.elementCenterY = this.elementHeight * this.origin
        this.elementRangeX = Math.max(this.elementCenterX, this.elementWidth - this.elementCenterX)
        this.elementRangeY = Math.max(this.elementCenterY, this.elementHeight - this.elementCenterY)
    }

    queueCalibration(delay) {
        clearTimeout(this.onCalibrationTimer)
        this.onCalibrationTimer = setTimeout(this.onCalibrationTimer, delay)
    }
